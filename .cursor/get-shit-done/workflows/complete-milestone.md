...
```bash
node "/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/templates/retrospective.md`.
