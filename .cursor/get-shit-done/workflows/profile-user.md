...
Key references:
- @/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md" "/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/commands/gsd/dev-preferences.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/.cursor/rules/
```
