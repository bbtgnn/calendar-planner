...
```
Task(
  prompt="Read /Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/templates/VALIDATION.md`
