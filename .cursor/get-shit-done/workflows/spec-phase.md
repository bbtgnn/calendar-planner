...
```bash
INIT=$(node "/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/get-shit-done/templates/spec.md.
