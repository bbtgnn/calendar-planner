...
- **Global scope**: `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/notes/`)
...
2. Glob `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/giovanniabbatepaolo/Desktop/calendar-planner/.cursor/notes/` — works in any directory
